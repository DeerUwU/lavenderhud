"Resource/UI/winpanel.res" //inside backpack
{
	"TFStatsSummary"
	{
	...
	"StatData"
	{
		...
		"NonInteractiveHeaders"
		{
			...
			"OverallRecordLabel" // where is this
			{
				"ControlName"	"Label"
		...
		"InteractiveHeaders"	
		{
			...
			"BarChartComboA"
			{
				...
				"Font"					"milku10"
				"border_override"		"rounded_grey_16x"
